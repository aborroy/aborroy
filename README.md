...
- **[alfresco-genai](https://github.com/aborroy/alfresco-genai)** ⭐28 - Private AI application to Content Management use cases with GenAI & Alfresco
...
- **[nuxeo-deployment](https://github.com/aborroy/nuxeo-deployment)**  `HTML` - Nuxeo LTS deployment built from source code.
...
- **[llama2-docker-multiarch](https://github.com/aborroy/llama2-docker-multiarch)** - Llama 2 Docker Image supporting AMD64 and ARCH64 architectures *(Updated: 2026-04-03)*
- **[alfresco-content-lake-ui](https://github.com/aborroy/alfresco-content-lake-ui)** - UI extension for Alfresco Content Lake to be used with ACA or ADW *(Updated: 2026-04-03)*
- **[content-lake-app](https://github.com/aborroy/content-lake-app)** - App for Hyland Content Lake *(Updated: 2026-04-03)*
- **[content-lake-app-deployment](https://github.com/aborroy/content-lake-app-deployment)** - Self-contained deployment for Content Lake App *(Updated: 2026-04-03)*
- **[alfresco-ai-framework](https://github.com/aborroy/alfresco-ai-framework)** - Sample application to apply Spring AI services to Alfresco Repository *(Updated: 2026-04-03)*
- **[alfresco-open-ass](https://github.com/aborroy/alfresco-open-ass)** - OpenSearch support for Alfresco Community *(Updated: 2026-04-03)*
- **[alfresco-genai](https://github.com/aborroy/alfresco-genai)** - Private AI application to Content Management use cases with GenAI & Alfresco *(Updated: 2026-04-03)*
- **[alfresco-mcp-poc](https://github.com/aborroy/alfresco-mcp-poc)** - Alfresco MPC (Model Context Protocol) PoC *(Updated: 2026-04-01)*
- **[nuxeo-deployment](https://github.com/aborroy/nuxeo-deployment)** - Nuxeo LTS deployment built from source code. *(Updated: 2026-04-01)*
- **[aiup-alfresco](https://github.com/aborroy/aiup-alfresco)** - A Claude Code plugin that packages Alfresco extension development as slash comma... *(Updated: 2026-03-31)*
...
*Last updated: 2026-04-06 07:50 UTC*
